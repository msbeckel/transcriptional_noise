...
def noise_plots(adata, plots_dir):
    ...
    g.map_dataframe(
        ...
        y='cor_dist',     # Y-axis: scallop noise
    ...
    g.set_axis_labels("Age", "cor_dist")  # Axis labels
    g.add_legend(title='Genotype')            # Add a shared legend

    # Save the figure
    plt.savefig(os.path.join(tn_plot_dir, "cor_dist_noise_by_cell_type_age_genotype.png"), bbox_inches='tight')
    plt.show()
